...
\title{A Selectable Precision Backend for \texttt{BHPtoolkit.jl}:\\
Float64, BigFloat, and MultiFloat}
\author{BHPtoolkit MST module}
\date{\today}
...
\begin{abstract}
The Mano--Suzuki--Takasugi (MST) solver in \texttt{BHPtoolkit.jl} computes
